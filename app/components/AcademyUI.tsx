...
export function Brand(){return <a className="brand" href="#home" aria-label="NXT Academy home"><Image src="/nxt-academy-logo.jpeg" fill unoptimized sizes="200px" alt="NXT Academy of Creative Studies" priority/></a>}

...
export function Brand(){return <a className="brand" href="#home" aria-label="NXT Academy home"><Image src="/nxt-academy-logo-transparent.png" fill unoptimized sizes="220px" alt="NXT Academy of Creative Studies" preload/></a>}

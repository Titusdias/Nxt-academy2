...
export function Brand(){return <a className="brand" href="#home" aria-label="NXT Academy of Creative Studies home"><span className="brand-mark"><Image src="/nxt-academy-new-logo.jpeg" fill unoptimized sizes="72px" alt="NXT Academy logo" priority/></span><span className="brand-name"><Image src="/nxt-academy-sign-wordmark.png" fill unoptimized sizes="330px" alt="NXT Academy of Creative Studies" priority/></span></a>}

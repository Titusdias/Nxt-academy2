...
const faqs = [
  ...
  ['Where is NXT Academy located?', 'NXT Academy of Creative Studies is in Bendur, Mangaluru, Karnataka. Contact admissions for directions.'],
...
export default function Home() {
  ...
  return <>
    ...
    <footer className="site-footer"><div className="footer-grid"><div><Brand /><p>Practical learning and professional growth for students in Bendur, Mangaluru.</p></div><div><h3>Explore NXT</h3><a href="#courses">Courses</a><a href="#why-nxt">Why NXT</a><a href="#student-life">Student Life</a></div><div><h3>Your Next Step</h3><a href="#courses">Hospitality</a><a href="#courses">Aviation</a><a href="#contact">Enquire</a><a href="#faq">FAQs</a></div><div className="footer-contact"><h3>Contact Us</h3><a href="tel:+918217337597"><Phone size={16} />+91 821 733 7597</a><a href="mailto:nxtacademy69@gmail.com"><Mail size={16} />nxtacademy69@gmail.com</a><a href="https://wa.me/918217337597" target="_blank" rel="noopener noreferrer"><MessageCircle size={16} />WhatsApp <ArrowUpRight size={14} /></a></div></div><div className="footer-bottom"><span>© {new Date().getFullYear()} NXT Academy of Creative Studies</span><span>Bendur, Mangaluru, Karnataka</span></div></footer>
